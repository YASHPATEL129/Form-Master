  ...
  >
    ...
    <div class="wrapper wrapper-top">
      <div class="container-fluid">
              ...
              <div class="card collapse-icon accordion-icon-rotate">
                ...
                >
                  <div class="card-body pl-3 pr-3">
                    <div class="row">
                      <div
                        class="col-xl-3 col-lg-3 col-sm-6 col-xs-12 colmspadding"
                      >
                      ...
                      <div
                        class="col-xl-2 col-lg-3 col-sm-6 col-xs-12 mb-0 btntop colmspadding"
                      >
                        <div class="form-group mb-0">
                          <a
                            class="save_form_details btn btn-success text-white btn-padding"
                            id="searchbtn"
                            ><i class="fa fa-search mr-2"></i>Go</a
                          >
        ...
        <div class="row showformfill" style="display: none">
          <div class="col-xl-12 col-lg-12 col-sm-12 colmspadding">
            <div class="card">
                      ...
                      <div class="row pr-2 pl-2">
                        ...
                        >
                          <p class="mb-1 font-weight-600">
                            ...
                            <span
                              >251 Attwell Drive - Operator Form - Monthly</span
                            >
                          </p>
                          ...
                          <p class="mb-0 font-weight-600">
                            ...
                            <span
                              >Are all portable fire extinguishers visually
                              inspected every month?At minimum, the following
                              list of items should be inspected extinguisher in
                              proper location and mounted.</span
                            >
                          </p>
                        </div>
                      </div>
                    ...
                    <div class="card mb-2 queshadow">
                      <div class="card-body">
                        <div class="row pl-2 pr-2">
                          <div
                            class="col-xl-1 col-lg-1 col-sm-2 col-xs-12 colmspadding"
                          >
                          ...
                          >
                            <div class="form-group mb-0 text-justify">
                              <p class="font-weight-700 mb-1 text-justify">
                                <span class="text-danger">*</span> Emergency
                                Power Systems & Lighting
                              </p>
                              <p class="mb-1">
                                Are the self-contained battery powered emergency
                                lights inspected and tested at least once a
                                month?
                              </p>
                            </div>
                      ...
                      <div class="card-body">
                        <div class="row pl-2 pr-2">
                          ...
                          >
                            <div class="form-group mb-0">
                              <p class="font-weight-700 mb-1 text-justify">
                                <span class="text-danger">*</span> Fire Alarm &
                                Voice Communication
                              </p>
                              <p class="mb-1 text-justify">
                                Is the status of the trouble signal indicators
                                on the fire panel checked every day?
                              </p>
                            </div>
                      ...
                      <div class="card-body">
                        <div class="row pl-2 pr-2">
                          ...
                          >
                            <div class="form-group mb-0">
                              <p class="font-weight-700 mb-1 text-justify">
                                <span class="text-danger">*</span> Fire
                                Department Access
                              </p>
                              <p class="mb-1 text-justify">
                                Is all fire department access for the
                                building(s) and fire protection equipment
                                maintained and kept free of obstructions? This
                                includes, but is not limited to streets, yards,
                                roadways, sprinkler or standpipe connections,
                                caps and access panels.
                              </p>
                            </div>
                      ...
                      <div class="card-body">
                        <div class="row pl-2 pr-2">
                          ...
                          >
                            <div class="form-group mb-0">
                              <p class="font-weight-700 mb-1 text-justify">
                                <span class="text-danger">*</span> Portable
                                Extinguishers
                              </p>
                              <p class="mb-1 text-justify">
                                Are all portable fire extinguishers visually
                                inspected every month?At minimum, the following
                                list of items should be inspected:- extinguisher
                                in proper location and mounted.- no obstructions
                                to access or visibility.- fullness by pressure
                                gauge reading (in operable range) and/or by
                                hefting. - physical damage.- operating
                                instructions visible.- safety seals and
                                pull-ring in place.The fire extinguisher's tags,
                                checklist or fire log book/records must be
                                initialed and dated after each inspection.
                              </p>
                            </div>
                        ...
                        <div class="row pl-2 pr-2">
                          ...
                          >
                            <div class="form-group mb-0">
                              ...
                              <p class="mb-1 text-justify">
                                Are all supervisory signal services tested every
                                six months for the items below?- valve
                                supervisory switches- tank water level devices-
                                building and tank water temperature supervisory
                                devices- any other sprinkler system supervisory
                                devices.
                              </p>
                            </div>
                            ...
                            <div class="form-group mb-0">
                              <div class="row pl-2 pr-2">
                                <div
                                  class="col-xl-4 col-lg-12 col-sm-12 col-xs-12 colmspadding"
                                >
                                  <select
                                    class="selectpicker"
                                    data-style="lineheight12 bg-transfer"
                        ...
                        <div class="row pl-2 pr-2">
                          ...
                          >
                            ...
                            <div class="form-group mb-0">
                              <div class="row pl-2 pr-2">
                                <div
                                  class="col-xl-2 col-lg-12 col-sm-12 col-xs-12 colmspadding"
                                >
                      ...
                      <div class="card-body">
                        <div class="row pl-2 pr-2 text-center">
                          <div
                            class="col-xl-12 col-lg-12 col-sm-12 col-xs-12 colmspadding"
                          >
                            <a class="btn btn-success btn-padding mr-2"
                              ><i class="fa fa-floppy-o mr-2"></i>Submit</a
                            >
                            <a class="btn btn-success btn-padding mr-2"
      ...
      <div class="modal-dialog modal-right-width">
        <div class="modal-content">
              ...
              <div class="card-body">
                <div class="row pr-3 pl-3">
                  <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
                    <p class="compact mb-0">
                      <span class="font-weight-700">Client</span>
                      <span class="displayblock font-medium-2"
                        >Scarborough Computer Centre (SCC)</span
                      >
                    </p>
                  </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
                    <p class="compact mb-0">
                      <span class="font-weight-700">Site</span>
                      <span class="displayblock font-medium-2"
                        >ON - London - 1680 Richmond Street North</span
                      >
                    </p>
                  </div>
                  ...
                  <div class="col-xl-4 col-lg-4 col-sm-4 colmspadding">
                    <p class="compact mb-0">
                      <span class="font-weight-700">Building</span>
                      <span class="displayblock font-medium-2 mt-1"
                        >Central Utility Building (CUB)</span
                      >
                    </p>
                  </div>
                </div>
            ...
            <div class="detailsbg">
              <div class="row pr-2 pl-2">
                ...
                >
                  <p class="mb-1 font-weight-600">
                    <span class="font-weight-700">Form Title:</span>
                    <span>251 Attwell Drive - Operator Form - Monthly</span>
                  </p>

                  <p class="mb-0 font-weight-600">
                    <span class="font-weight-700">Description:</span>
                    <span
                      >Are all portable fire extinguishers visually inspected
                      every month?At minimum, the following list of items should
                      be inspected extinguisher in proper location and
                      mounted.</span
                    >
                  </p>
                </div>
              ...
              <div class="card-body">
                <div class="row pl-2 pr-2">
                  ...
                  >
                    <div class="form-group mb-0 text-justify">
                      <p class="font-weight-700 mb-1 text-justify">
                        <span class="text-danger">*</span> Emergency Power
                        Systems & Lighting
                      </p>
                      <p class="mb-1">
                        Are the self-contained battery powered emergency lights
                        inspected and tested at least once a month?
                      </p>
                    </div>
                ...
                <div class="row pl-2 pr-2">
                  ...
                  >
                    <div class="form-group mb-0">
                      ...
                      <p class="mb-1 text-justify">
                        Is the status of the trouble signal indicators on the
                        fire panel checked every day?
                      </p>
                    </div>
              ...
              <div class="card-body">
                <div class="row pl-2 pr-2">
                  ...
                  >
                    <div class="form-group mb-0">
                      <p class="font-weight-700 mb-1 text-justify">
                        <span class="text-danger">*</span> Fire Department
                        Access
                      </p>
                      <p class="mb-1 text-justify">
                        Is all fire department access for the building(s) and
                        fire protection equipment maintained and kept free of
                        obstructions? This includes, but is not limited to
                        streets, yards, roadways, sprinkler or standpipe
                        connections, caps and access panels.
                      </p>
                    </div>
                ...
                <div class="row pl-2 pr-2">
                  ...
                  >
                    <div class="form-group mb-0">
                      ...
                      <p class="mb-1 text-justify">
                        Are all portable fire extinguishers visually inspected
                        every month?At minimum, the following list of items
                        should be inspected:- extinguisher in proper location
                        and mounted.- no obstructions to access or visibility.-
                        fullness by pressure gauge reading (in operable range)
                        and/or by hefting. - physical damage.- operating
                        instructions visible.- safety seals and pull-ring in
                        place.The fire extinguisher's tags, checklist or fire
                        log book/records must be initialed and dated after each
                        inspection.
                      </p>
                    </div>
                ...
                <div class="row pl-2 pr-2">
                  ...
                  >
                    <div class="form-group mb-0">
                      ...
                      <p class="mb-1 text-justify">
                        Are all supervisory signal services tested every six
                        months for the items below?- valve supervisory switches-
                        tank water level devices- building and tank water
                        temperature supervisory devices- any other sprinkler
          ...
          <div class="modal-footer bg-white">
            <a
              class="btn btn-success float-right btn-padding"
              data-dismiss="modal"
              ><i class="fa fa-times mr-2"></i>Close</a
            >
            <a
    ...
    <script type="text/javascript" src="javascript/fillForms.js"></script>
