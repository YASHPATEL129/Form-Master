...
document.write(
  "<img src='assets/images/users/face.jpg' alt='user' class='rounded-circle'> <span class='ml-1 pro-user-name'>" +
    usertype +
...
document.write("</a>");
document.write(
  "<a href='/logIn' onclick='javascript:window.sessionStorage.clear()' class='dropdown-item notify-item border-0'>"
);
